...
model_params = {
    ...
    "p_north_to_north": UserSettableParameter('slider', 'To North', 0.00, 0, 1, 0.01),
    "p_north_to_west": UserSettableParameter('slider', 'To West', 0.0, 0, 1, 0.01),
    "p_north_to_east": UserSettableParameter('slider', 'To East', 1.0, 0, 1, 0.01),
    ...
    "p_east_to_east": UserSettableParameter('slider', 'To East', 0.0, 0, 1, 0.01),
    ...
    "p_south_to_south": UserSettableParameter('slider', 'To South', 0.0, 0, 1, 0.01),
}
