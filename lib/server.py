...
model_params = {
    ...
    "max_speed_horizontal": UserSettableParameter('slider', "Max speed horizontal road", 5, 5, 24, 1),
    "max_speed_vertical": UserSettableParameter('slider', "Max speed vertical road", 5, 5, 24, 1),
    ...
    "p_car_spawn_north": UserSettableParameter('slider', "Spawn Probability", 0.0, 0, 1, 0.1),
    ...
    "p_car_spawn_west": UserSettableParameter('slider', "Spawn Probability", 0.0, 0, 1, 0.1),
    ...
    "p_car_spawn_east": UserSettableParameter('slider', "Spawn Probability", 0.0, 0, 1, 0.1),
    ...
    "p_car_spawn_south": UserSettableParameter('slider', "Spawn Probability", 1, 0, 1, 0.1),
