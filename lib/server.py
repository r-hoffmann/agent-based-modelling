...
model_params = {
    ...
    "p_car_spawn_south": UserSettableParameter('slider', "Spawn Probability", 0.2, 0, 1, 0.01),
    "p_south_to_north": UserSettableParameter('slider', 'To North', 0, 0, 1, 0.01),
    ...
    "p_car_spawn_east": UserSettableParameter('slider', "Spawn Probability", 0.2, 0, 1, 0.01),
    "p_east_to_north": UserSettableParameter('slider', 'To North', 0, 0, 1, 0.01),
    "p_east_to_west": UserSettableParameter('slider', 'To West', 0, 0, 1, 0.01),
    "p_east_to_east": UserSettableParameter('slider', 'To East', 1, 0, 1, 0.01),
    "p_east_to_south": UserSettableParameter('slider', 'To South', 0, 0, 1, 0.01),

    "east": UserSettableParameter('static_text', value="From East"),
    "p_car_spawn_west": UserSettableParameter('slider', "Spawn Probability", 0.2, 0, 1, 0.01),
    ...
    "p_west_to_east": UserSettableParameter('slider', 'To East', 0, 0, 1, 0.01),
