...
model_params = {
    ...
    "intersection_type": UserSettableParameter('choice', 'Intersection type', value='Smart lights',
                                              choices=['Fourway', 'Traffic lights', 'Equivalent', 'Smart lights']),
    "traffic_light_title": UserSettableParameter('static_text', value="Traffic lights duration"),
    "t_from_north": UserSettableParameter('slider', 'From North', 20, 0, 50, 1),
    "t_from_west": UserSettableParameter('slider', 'From West', 20, 0, 50, 1),
    "t_from_east": UserSettableParameter('slider', 'From East', 20, 0, 50, 1),
    "t_from_south": UserSettableParameter('slider', 'From South', 20, 0, 50, 1),
