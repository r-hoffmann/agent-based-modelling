...
model_params = {
    ...
    "max_speed_horizontal": UserSettableParameter('slider', "Max speed horizontal road", 17, 5, 24, 1),
    "max_speed_vertical": UserSettableParameter('slider', "Max speed vertical road", 17, 5, 24, 1),
    "alpha_factor": UserSettableParameter('slider', "Antisocial alpha factor", 5, 0, 10, .01),
    ...
    "p_car_spawn_north": UserSettableParameter('slider', "Spawn Probability", 0.1, 0, 1, 0.1),
    "p_north_to_north": UserSettableParameter('slider', 'To North', 1, 0, 1, 0.01),
    "p_north_to_west": UserSettableParameter('slider', 'To West', 1, 0, 1, 0.33),
    "p_north_to_east": UserSettableParameter('slider', 'To East', 1, 0, 1, 0.33),
    "p_north_to_south": UserSettableParameter('slider', 'To South', 1, 0, 1, 0.33),
    "west": UserSettableParameter('static_text', value="From West"),
    "p_car_spawn_west": UserSettableParameter('slider', "Spawn Probability", 0.1, 0, 1, 0.1),
    "p_west_to_north": UserSettableParameter('slider', 'To North', 1, 0, 1, 0.33),
    "p_west_to_west": UserSettableParameter('slider', 'To West', 1, 0, 1, 0.01),
    "p_west_to_east": UserSettableParameter('slider', 'To East', 1, 0, 1, 0.33),
    "p_west_to_south": UserSettableParameter('slider', 'To South', 1, 0, 1, 0.33),
    "east": UserSettableParameter('static_text', value="From East"),
    "p_car_spawn_east": UserSettableParameter('slider', "Spawn Probability", 0.1, 0, 1, 0.1),
    "p_east_to_north": UserSettableParameter('slider', 'To North', 1, 0, 1, 0.33),
    "p_east_to_west": UserSettableParameter('slider', 'To West', 1, 0, 1, 0.33),
    "p_east_to_east": UserSettableParameter('slider', 'To East', 1, 0, 1, 0.01),
    "p_east_to_south": UserSettableParameter('slider', 'To South', 1, 0, 1, 0.33),
    "south": UserSettableParameter('static_text', value="From South"),
    "p_car_spawn_south": UserSettableParameter('slider', "Spawn Probability", 0.1, 0, 1, 0.1),
    "p_south_to_north": UserSettableParameter('slider', 'To North', 1, 0, 1, 0.33),
    "p_south_to_west": UserSettableParameter('slider', 'To West', 1, 0, 1, 0.33),
    "p_south_to_east": UserSettableParameter('slider', 'To East', 1, 0, 1, 0.33),
    "p_south_to_south": UserSettableParameter('slider', 'To South', 1, 0, 1, 0.01),
}
